...
def get_config():
    ...
    parser.add_argument('--module_name', type=str, default="DDA_SRGAN", help='module name.')
    parser.add_argument('--cuda', type=str, default="0, 1, 2, 3", help='a list of gpus.')
    parser.add_argument('--exe_mode', type=str, default="generating", help='execution mode : {training, evaluating, generating}')
    ...
    parser.add_argument('--lr_height', type=int, default=50, help="The height of lower resoultion input image (pixel value).")  
    parser.add_argument('--lr_width', type=int, default=40, help="The width of lower resoultion input image (pixel value).")
    parser.add_argument('--img_scalar', type=int, default=4, help="The size of image scalar (from low resolution to super resolution).")
    parser.add_argument('--learn_rate', type=float, default=1e-4, help="learning rate")  # 5e-5
    ...
    parser.add_argument('--n_DRB', type=int, default=3, help="The number of residual in residual dense block(RRDB) in the part of Generator.")
    ...
    parser.add_argument('--res_scalar', type=int, default=0.2, help="residual scalar")
    
    ## Learning setting (*): 
    parser.add_argument('--data_set_root', type=str, default="datasets", help="The root of directory of the data set.")
    parser.add_argument('--data_set_name', type=str, default="CelebA", help="The name of dataset, Iris - {CASIA_lab, IOM}, Face - {CelebA}")
    ...
    parser.add_argument('--batch_size', type=int, default=24, help="The number of batch size during training.")
    parser.add_argument('--epochs', type=int, default=40001, help="The number of epoch during training.")
    parser.add_argument('--samp_img_intval', type=int, default=100, help="The interval of sampling the image during training epoch.")
    parser.add_argument('--save_dir_name', type=str, default="training/SWCA_GAN/exp000_CelebA", help="The directory name of saving sample images under ../images dir.")
    ...
    parser.add_argument('--exp_tag', type=str, default="000", help="The tag of experiment, {main_ver}_{brnch}_{patch}, ex. 000_1_2, the patch for bug in version 000 with 1 brnch to new functionality.")
    
    ## Generating setting : 
    parser.add_argument('--n_sr_img', type=int, default=36001, help="The number of lower resolution with generate sr images.")
    parser.add_argument('--lr_img_dir', type=str, default="eval_set", help="The directory name of low resolution set.")
    parser.add_argument('--save_img_dir', type=str, default="generating/SWCA_GAN/exp000_CelebA", help="The directory name of generated images.")
