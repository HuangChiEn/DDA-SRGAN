...
def get_config():
    ...
    parser.add_argument('--epochs', type=int, default=10000, help="The number of epoch during training.")
    parser.add_argument('--samp_img_intval', type=int, default=100, help="The interval of sampling the image during training epoch.")
    parser.add_argument('--save_dir_name', type=str, default="training/MA_SRGAN/exptmp_CelebA", help="The directory name of saving sample images under ../images dir.")
    ...
    parser.add_argument('--learn_rate', type=int, default=1e-4, help="learning rate")
    
    ## Generating setting : 
    parser.add_argument('--n_sr_img', type=int, default=36010, help="The number of lower resolution with generate sr images.")
    
    parser.add_argument('--lr_img_dir', type=str, default="eval_set", help="The directory name of low resolution set.")
    parser.add_argument('--save_img_dir', type=str, default="generating/MA_SRGAN/exptmp_CASIA_lab", help="The directory name of generated images.")
