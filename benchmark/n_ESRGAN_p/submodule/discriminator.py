...
def build_discriminator(hr_shape, num_of_filts):
    ...
    ## Up sampling with 2x scalar each time
    ...
    ## For sure the range of relativistic average loss, activation='sigmoid'
    validity = Dense(1, kernel_initializer='glorot_uniform')(d10)  
