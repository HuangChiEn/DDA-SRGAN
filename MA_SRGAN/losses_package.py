...
## Textural - loss 
## Although perceptual loss can improve the quality of reconstruc..
def text_l2_loss(fake_gram, real_gram):
    textural_loss = tf.losses.mean_squared_error(fake_gram, real_gram)
