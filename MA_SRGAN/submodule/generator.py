...
def build_generator(lr_shape, num_of_filts, num_of_RRDRB, num_of_DRB, resScal, upScalar, 
                    residual_plus=True, n_residual_plus=True):
    
    def learned_gaussian_noise(input_tensor):
        def gau_noise():  ## return 1-dim tensor of noise by "expand_dims" function.
            return KTF.expand_dims(KTF.random_normal(shape=(1,), mean=0.0, stddev=1.0))
